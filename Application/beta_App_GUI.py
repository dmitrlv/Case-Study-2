...
f = Figure(figsize=(6,3), dpi=75)
k = Figure(figsize=(6,3), dpi=75)
l = Figure(figsize=(6,3), dpi=75)
m = Figure(figsize=(6,3), dpi=75)
...
frameUser1.place(x=350, y=200)
labelUser1 = Label(frameUser1, text="Windows Client")
...
buttonConnect = Button(frameUser1, text="Connect", command = lambda:func.usersConnect())
buttonConnect.pack()
